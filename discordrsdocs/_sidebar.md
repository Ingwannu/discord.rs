...
- API Reference
  ...
  - [Discord API Coverage](#/docs/api/discord-api-coverage)
  - [Lobby](#/docs/api/lobby)
  - [Webhook Events](#/docs/api/webhook-events)
  - [Interactions Endpoint](#/docs/api/interactions-endpoint)
  - [Application Framework](#/docs/api/app-framework)
  - [Sharding](#/docs/api/sharding)
  - [Voice](#/docs/api/voice)
  - [Live DAVE Validation](#/docs/api/live-dave-validation)
- Source Docs
